...
public class OpenGLRenderer implements Renderer
{
	...
	private static int failed_attemps=0;
	...
	public OpenGLRenderer(Context context, Handler handler)
	{
		...
		rot1 = rgen.nextInt(4) * 90;
		rot2 = rgen.nextInt(4) * 90;
		rot3 = rgen.nextInt(4) * 90;

		// Initialize a spinner
		spinner = new Spinner (1.1f, 1.1f, 1.1f);
		spinner.loadBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.slot_6pics));
...
//		Log.i(DEBUG_TAG, "onsurfaceChanged()");
	...
	public boolean doTouchEvent (MotionEvent event)
	{
		...
		if (event.getAction() == MotionEvent.ACTION_DOWN) {
			...
			Log.i("Project Logging", "Touch at " + x + "," + y);
			if(x>108&&x<608 &&y>822 && y<987) {
				synchronized (this) {
